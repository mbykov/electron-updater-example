...
- [Complete electron-updater HTTP example](https://gist.github.com/mbykov/0ff845e8e3f59dbe7eaf2bf24443f104)

**NOTE:** If you want to run through this whole process, you will need to fork this repo on GitHub and replace all instances of `mbykov` with your GitHub username before doing the following steps.
...
6. Release the release on GitHub by going to <https://github.com/mbykov/electron-updater-example/releases>, editing the release and clicking "Publish release."

7. Download and install the app from <https://github.com/mbykov/electron-updater-example/releases>.
